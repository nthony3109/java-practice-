...
public class BookTask {
    ...
    private static List<BookTask> collection = new ArrayList<>();

    // Constructor
    public BookTask(String title, String author, String isbn) {
    ...
    public static void removeBook(String keyword) {
        ...
        boolean found = false;
        List<BookTask> toRemove = new ArrayList<>();

        for (BookTask book : collection) {
        ...
        while (running) {
            ...
            switch (choice) {
                case "1":
                    ...
                    new BookTask(title, author, isbn).addBook();
                    break;
